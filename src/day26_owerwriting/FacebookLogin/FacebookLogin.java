...
// neden bu alttakileri olusturduk sadece cunku bunlar tum tarayicilarda ortakm oldugu icin:inheritence
    ...
    //    //methods : openBrowser , goToUrl , passingCredentials , closebrowser
    public void openBrowser(){  //overriding yaptik bunu child'da  //ayrica buna parametre girip de yapabilirdin bu secenegi sectik
    ...
    public void passingCredentials(String username , String password){
        setUsername(username); //instance olduklari icin direkt cektik
