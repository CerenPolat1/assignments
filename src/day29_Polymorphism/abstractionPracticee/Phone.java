...
//    abstract methods: texting(), calling()
    ...
    public static String brand;  //bunu da instance yapabilridik, static yarattik cok fazla degisiklik yapmiycaz diye
    public String model;
    public double price;
...
interface downloaddable{  //interface class
...
interface appleStore extends downloaddable{    //
    ...
    String storeName="Apple";//final static //neden final ve static oldu cunku interface bunlari default sayar
