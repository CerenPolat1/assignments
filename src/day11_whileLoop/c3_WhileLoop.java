...
public class c3_WhileLoop {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0 ; i <100 ; i++){
            //starting point int i = 0   // initilization(baslangic)
...
//        }
        ...
        while (number2 > 0){ //5 4 3 2 1
            System.out.println(number2);//5 4 3 2 1  //system.out u number2'dan once yazdigimizda tum atananlari 5'ten itibarenverir
            number2--;//4 3 2 1 0
        }
    }
}