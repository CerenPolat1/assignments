...
public class c1_shoeObject3 {
    ...
    public static void main(String[] args) {
        //to be able to create an object from shoe class i need to call my class and import in this class
        ...
        System.out.println(Arrays.toString(shoes));  //we weren't able to print it without Arrays.toString   !!!!!!!!!!!!!!!!!!!!!!!!
