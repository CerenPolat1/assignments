...
public class c5_List {
   ...
   // !!!!!!!  what is the differences between array and array list    !!!!!!!!!!!!interiew Question!!!!!!!!!
    ...
    public static void main(String[] args) {
        ...
        list2.add(25); //size 1 index 0   //bu size'lar lst2'nin icinde oldugundan size 1 diye gorunuyor buradan
        ...
        Integer numIndex1=list2.get(1);      //get, sana index noyu verir //55, get, char'a karsilik gelir
        System.out.println("numIndex1 = " + numIndex1); //55
        ...
        //unboxing will help us to store wrapper object to primitive data type

        System.out.println(number0);


        ArrayList<String> nameList=new ArrayList<>(); //buradayken size 0
        nameList.add("Meral");
        nameList.add("Recep");
        nameList.add("Musab");
        ...
        for (int i=0 ; i <= nameList.size() -1 ; i ++){
            ...
            //namelist[i]                    //i, arraylist sayisini veriyor run'da gormek icin ekledik
        }

        nameList.add("ridvan"); // namelistin size'i size 4 iken 5 oldu
        nameList.add("Jessica"); // 6 oldu
