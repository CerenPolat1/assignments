...
//  error verir cunku ikisi de int degil veya short degil, turlerin ayni olmasi gerekir !!!!!!!! Integer myInt3=sh1; !!!!!!!!//Integer is another form of int primitive data type
...
//        !!!!!!!!!!!!!!!!!!!!toString method is used to convert wrapper objects to string!!!!!!!!!!!!!!!
        ...
        System.out.println("str = " + str);  //text olarak var suan 155
