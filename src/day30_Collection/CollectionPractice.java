...
// 1. write a program that can remove the duplicated characters from String
        ...
        System.out.println(Arrays.toString(letters)); //bunu yazmazsan sikintili run eder
        ...
        LinkedHashSet<String> result= new LinkedHashSet<>(Arrays.asList(letters)); //hashset sirayla verir ve dublicaate olmadan
...
//bu islemleri foor loop yaparak da yapabilirdik

        //what was the method to put them in string?  tostring

        System.out.println("result1 = " + result1);
        System.out.println("result2 = " + result2);

        String newStr1=result1.toString(); // we make tostring to be able to compare
